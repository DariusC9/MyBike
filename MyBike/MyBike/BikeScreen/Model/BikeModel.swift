...
struct BikeModel {
    ...
    static func empty() -> BikeModel {
        return BikeModel(ID: 123456, color: .white, name: "Test Bike", distance: 123, wheelSize: 18, bikeImages: BikeImages(topImageName: "bike_electric_over",
